...
class FirstPage extends StatelessWidget {
  ...
  void onClickToPageLogin(BuildContext context, bool isCreate) {
    Navigator.of(context).push(
      MaterialPageRoute(
          builder: (ctx) => !isCreate ? const LoginPage() : const Createpage()),
    );
  }
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          onClickToPageLogin(context, false);
                        },
                        child: Container(
                          height: 55,
                          decoration: const BoxDecoration(
                    ...
                    Expanded(
                      child: InkWell(
                        onTap: () {
                          onClickToPageLogin(context, true);
                        },
                        child: Container(
                          alignment: Alignment.center,
                          height: 65,
